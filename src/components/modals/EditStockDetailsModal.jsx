...
function EditStockDetailsModal({ isOpen, onClose, supplierOptions }) {
                ...
                <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-2xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-8">
                        ...
                        <div className="pt-4 flex justify-end space-x-3">
                            ...
                            <button type="submit" className="px-6 py-2 text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-md cursor-pointer">Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>

...
function EditCountingModal({ isOpen, onClose, initialData }) {
    ...
    const [formValues, setFormValues] = useState({
        CountDate: initialData ? formatDateForInput(initialData.count_date) : '',
    ...
    React.useEffect(() => {
        if (initialData) {
            setFormValues({
                CountDate: formatDateForInput(initialData.count_date),
                Warehouse: initialData.warehouse,
                remarks: initialData.remarks,
            });
        }
...
export default EditCountingModal;